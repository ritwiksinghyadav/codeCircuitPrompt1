...
export default function HomePage() {
  return (
    <>
      <div className="w-full bg-yellow-100 dark:bg-yellow-900 text-yellow-900 dark:text-yellow-100 py-2 px-4 text-center text-sm font-medium border-b border-yellow-300 dark:border-yellow-800">
        <span>
